...
document pxml
Print the tree of an already opened XML document (i.e., an xmlDocPtr)
to the screen. This will probably be several pages long.
E.g.,
given: xmlDocPtr doc = xmlParseFile(infile);
use: pxml doc
...
This macro will step forward in the list, then show the value at that
next element. Give the type of the list data as the only argument.
...
This is intended to be used by phead and pnext, q.v., It sets $pdata
